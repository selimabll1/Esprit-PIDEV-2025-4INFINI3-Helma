...
public class DashboardService {
    ...
    private String deriveMainAlert(HealthScoreDto.Response health,
        ...
        if (burnRate != null && burnRate.runwayMonths() != null && burnRate.runwayMonths().doubleValue() < 2.0) {
    ...
    private String deriveMainPositive(CashFlowDto.Response cashFlow,
        ...
        if (cashFlow != null && cashFlow.netFlow() != null && cashFlow.netFlow().doubleValue() > 0) {
        ...
        return "Le tableau de bord est disponible.";
    }
